...
/*
   "Savings ZFI" is obtained when ZFI is deposited into
   this contract. Each "Savings ZFI" accrues ZFI interest
   at the "ZFI Savings Rate".
   ...
   - `dsr`: the ZFI Savings Rate
   - `pie`: user balance of Savings ZFI
...
contract Pot {
    ...
    // --- Data ---
    mapping (address => uint256) public pie;  // Normalised Savings ZFI [wad]

    uint256 public Pie;   // Total Normalised Savings ZFI  [wad]
    uint256 public dsr;   // The ZFI Savings Rate          [ray]
